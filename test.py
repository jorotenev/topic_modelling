...
def findProbabilitiesOfVisualWordsGivenADocument(lda, topic_probabilities_for_doc, visi_word_probabilities):
...
def test():
    ...
    modePath = config.model_folder + modelFname
    
    lda = gensim.models.LdaModel.load(modePath)
    ...
    for index, bow in enumerate(bows):
        ...
        findProbabilitiesOfVisualWordsGivenADocument(lda, topic_probabilities_for_doc, probabilities_of_visual_terms_in_topics)
